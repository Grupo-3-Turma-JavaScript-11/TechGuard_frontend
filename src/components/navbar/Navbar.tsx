        ...
        <div className="flex items-center gap-6">
          ...
          {!usuario.token ? (
            <div className="flex items-center space-x-6">
              ...
              <Link to="/login" className="bg-emerald-500 text-white px-6 py-2 rounded-full font-bold hover:bg-[#D4AF37] hover:shadow-lg hover:shadow-amber-500/20 transition-all duration-300">
                Área do Cliente
              </Link>
